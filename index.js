...
async function run() {
  try {
    ...
    const menuCollection = client.db("vegiterianDB").collection("Menu");
    const reviewCollection = client.db("vegiterianDB").collection("reviews");
    const cartCollection = client.db("vegiterianDB").collection("carts");
